...
setGeneric( "interval_union_old", def = function( x, ... ) standardGeneric( "interval_union_old" ) )
...
setMethod(
          ...
          function( x, ... ) {
            x <- combine( x, ... )
            result <- as( interval_union_old( as( x, "Intervals_full" ) ), "Intervals" )
            if ( type( x ) == "Z" ) {
...
setMethod(
          ...
          function( x, ... ) {
            ...
            else return( do.call( interval_union_old, args ) )
          }
          )
